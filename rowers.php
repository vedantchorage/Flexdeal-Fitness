...
// Query for Rower products
$rowersQuery = "SELECT * FROM products WHERE LOWER(type) = 'Rower'";
$rowersResult = $pdo->query($rowersQuery);
$rowersProduct = $rowersResult->fetchAll(PDO::FETCH_ASSOC);
  ...
  <header id="main-header">
    ...
    <section class="product-section">
        <div class="section-header">
            <h2>Premium Rowing Machines</h2>
            <p>Experience full-body workouts with our high-quality rowing machines</p>
        </div>
     
        <div class="products-container">
            <?php foreach ($rowersProduct as $product): ?>
            <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Rowers</span>
                    <h3>
