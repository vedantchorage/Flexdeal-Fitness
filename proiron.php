...
// Query for PlateLoaded_Firm products
$proironQuery = "SELECT * FROM products WHERE LOWER(type) = 'Proiron'";
$proironResult = $pdo->query($proironQuery);
$proironProduct = $proironResult->fetchAll(PDO::FETCH_ASSOC);
    ...
    <section class="product-section">
        <div class="section-header">
          ...
          <div class="products-container">
            <?php foreach ($proironProduct as $product): ?>
            <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Proiron</span>
                    <h3>
