...
$kaesunQuery = "SELECT * FROM products WHERE LOWER(type) = 'Kaesun'";
$kaesunResult = $pdo->query($kaesunQuery);
$kaesunProduct = $kaesunResult->fetchAll(PDO::FETCH_ASSOC);
    ...
    <section class="product-section">
        <div class="section-header">
          ...
          <div class="products-container">
            <?php foreach ($kaesunProduct as $product): ?>
            <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Kaesun</span>
                    <h3>
