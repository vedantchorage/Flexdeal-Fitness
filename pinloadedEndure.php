...
// Query for PinLoaded_Endure products
$endureQuery = "SELECT * FROM products WHERE LOWER(type) = 'PinLoaded' and Categories = 'ENDURE'";
$endureResult = $pdo->query($endureQuery);
$endureProduct = $endureResult->fetchAll(PDO::FETCH_ASSOC);
    ...
    <section class="product-section">
        <div class="section-header">
          ...
          <div class="products-container">
            <?php foreach ($endureProduct as $product): ?>
                        <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Endura</span>
                    <h3>
