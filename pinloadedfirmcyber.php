...
// Query for PinLoaded_FirmCyber products
$firmcyberQuery = "SELECT * FROM products WHERE LOWER(type) = 'PinLoaded' and Categories = 'FirmCyber'";
$firmcyberResult = $pdo->query($firmcyberQuery);
$firmcyberProduct = $firmcyberResult->fetchAll(PDO::FETCH_ASSOC);
    ...
    <section class="product-section">
        <div class="section-header">
          ...
          <div class="products-container">
            <?php foreach ($firmcyberProduct as $product): ?>
            <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Firm Cyber</span>
                    <h3>
