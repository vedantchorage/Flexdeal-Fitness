...
// Query for PinLoaded_Elitepro products
$eliteproQuery = "SELECT * FROM products WHERE LOWER(type) = 'PinLoaded'  and Categories =  'ELITEPRO'";
$eliteproResult = $pdo->query($eliteproQuery);
$eliteproProduct = $eliteproResult->fetchAll(PDO::FETCH_ASSOC);
    ...
    <section class="product-section">
        <div class="section-header">
          ...
          <div class="products-container">
            <?php foreach ($eliteproProduct as $product): ?>
            <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Elite Pro</span>
                    <h3>
