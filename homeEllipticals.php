...
// Query for Elleptical products
$homeEllepticalQuery = "SELECT * FROM products WHERE LOWER(type) = 'HomeElleptical' order by price ASC";
$homeEllepticalResult = $pdo->query($homeEllepticalQuery);
$homeEllepticalProduct = $homeEllepticalResult->fetchAll(PDO::FETCH_ASSOC);
...
<body>
    ...
    <!-- Elliptical Products Section -->
    <section class="product-section">
        <div class="section-header">
            <h2>Premium Home Ellipticals</h2>
            <p>Browse our wide selection of high-quality elliptical trainers for your home gym</p>
        </div>



        <div class="products-container">
            <?php foreach ($homeEllepticalProduct as $product): ?>
            <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Home Ellipticals</span>
                    <h3>
