...
$gymEllipticalQuery = "SELECT * FROM products WHERE LOWER(type) = 'Elleptical_Gym' order by price ASC";
$gymEllipticalResult = $pdo->query($gymEllipticalQuery);
$gymEllipticalProduct = $gymEllipticalResult->fetchAll(PDO::FETCH_ASSOC);
...
<body>
 ...
 <section class="product-section">
        <div class="section-header">
            <h2>Premium Gym Ellipticals</h2>
            <p>Commercial-grade elliptical trainers for professional fitness centers and home gyms</p>
        </div>
         ...
         <div class="products-container">
            <?php foreach ($gymEllipticalProduct as $product): ?>
            <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Gym Ellipticals</span>
                    <h3>
