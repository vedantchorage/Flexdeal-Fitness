...
// Query for Bike_HomeFitness products
$homeExerciseQuery = "SELECT * FROM products WHERE LOWER(type) = 'Bike_HomeFitness' order by price ASC";
$homeExerciseResult = $pdo->query($homeExerciseQuery);
$homeExerciseProduct = $homeExerciseResult->fetchAll(PDO::FETCH_ASSOC);
...
<body>
    ...
    <section class="product-section">
        <div class="section-header">
            <h2>Premium Home Bike</h2>
            <p>xplore our range of high-quality home exercise bikes for your fitness journey</p>
        </div>
        ...
        <div class="products-container">
            <?php foreach ($homeExerciseProduct as $product): ?>
            <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Home Exercise Bike</span>
                    <h3>
