...
// Query for Treadmill products
$hometreadmillQuery = "SELECT * FROM products WHERE LOWER(type) = 'HomeTreadmill' order by price ASC";
$hometreadmillResult = $pdo->query($hometreadmillQuery);
$hometreadmillProduct = $hometreadmillResult->fetchAll(PDO::FETCH_ASSOC);
...
<head>
    ...
    <title>Premium Home Treadmills | FlexDeal Fitness</title>
                ...
                <ul id="main-nav">
                    ...
                    <li><a href="gymfitness.php">GymFitness </i></a>
                        <ul class="dropdown-menu mega-menu">
                            ...
                            <li class="dropdown-image-box">
                                <img src="https://img.freepik.com/free-photo/gym-with-indoor-cycling-equipment_23-2149270210.jpg?uid=R202996531&ga=GA1.1.1448600281.1749010097&semt=ais_hybrid&w=740"
        ...
        <div class="products-container">
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Home Treadmills</span>
                    <h3>
...
">
    ...
    <div class="cart-sidebar" id="cartSidebar">
        ...
        <div class="cart-actions">
            <a href="https://wa.me/917776090461?text=I%20have%20some%20quote%20requests%20from%20your%20website"
                class="cart-checkout-btn">Contact on WhatsApp</a>
            <button class="cart-view-btn" onclick="sendCartByEmail()">Send Quote Requests via Email</button>
        </div>
    </div>
                ...
                <div class="footer-contact">
                    ...
                    <div class="contact-item">
                        ...
                        <div>Inside 93 Avenu Mall
                            ...
                            Solapur Road, Near FATIMA NAGAR JUNCTION, Opposite CROMA, Wanowrie, Pune, Maharashtra 411022
                        </div>
                    </div>
                    <div class="contact-item">
