...
// Query for PlateLoaded_Maxpro products
$maxproQuery = "SELECT * FROM products WHERE LOWER(type) = 'PlateLoaded' and Categories = 'maxpro'";
$maxproResult = $pdo->query($maxproQuery);
$maxproProduct = $maxproResult->fetchAll(PDO::FETCH_ASSOC);
    ...
    <section class="product-section">
        <div class="section-header">
          ...
          <div class="products-container">
            <?php foreach ($maxproProduct as $product): ?>
            <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Maxpro</span>
                    <h3>
