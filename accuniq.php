...
$accuniqQuery = "SELECT * FROM products WHERE product_name like 'accuniq%'";
$accuniqResult = $pdo->query($accuniqQuery);
$accuniqProduct = $accuniqResult->fetchAll(PDO::FETCH_ASSOC);
...
<body>
  ...
  <section class="product-section">
        ...
        <div class="products-container">
            <?php foreach ($accuniqProduct as $product): ?>
            <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Accuniq</span>
                    <h3>
