...
// Query for StrengthAndBenches products
$strengthQuery = "SELECT * FROM products WHERE LOWER(type) = 'StrengthAndBenches' order by price ASC";
$strengthResult = $pdo->query($strengthQuery);
$strengthProduct = $strengthResult->fetchAll(PDO::FETCH_ASSOC);
...
<body>
 ...
 <div class="products-container">
            <?php foreach ($strengthProduct as $product): ?>
            <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Strength and Bikes</span>
                    <h3>
  ...
  document.body.style.overflow = "hidden";
    ...
    function openQuoteForm(productName, productPrice, productImage) {
        ...
        if (!/^https?:\/\//i.test(imageUrl)) {
            ...
            imageUrl = origin + '/FlexDeal/' + imageUrl.replace(/^\/+/, '');
        }
