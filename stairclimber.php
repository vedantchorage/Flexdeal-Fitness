...
$stairQuery = "SELECT * FROM products WHERE LOWER(type) = 'StairClimber'";
$stairResult = $pdo->query($stairQuery);
$stairProduct = $stairResult->fetchAll(PDO::FETCH_ASSOC);
  ...
  <header id="main-header">
    ...
    <section class="product-section">
        ...
        <div class="products-container">
            <?php foreach ($stairProduct as $product): ?>
            <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Stair Climber</span>
                    <h3>
