...
<div class="container">
    ...
    <div class="image-container">
        <img src="https://welcarefitness.com/image/cache/catalog/FMDS01%20CHEST%20SHOULDER%20PRESS-1000x1000.jpg" alt="Firm Cyber" class="product-image">
        <div class="overlay">
            <a href="pinloadedfirmcyber.php" class="quick-view">Quick View</a>
        </div>
    </div>
    <div class="product-info">
        <h3 class="product-name">Firm Cyber</h3>
    </div>
</div>
        ...
        <div class="product-card">
             <div class="product-badge">Bestseller</div>
            <div class="image-container">
                <img src="https://welcarefitness.com/image/cache/catalog/FM8003%20PEC%20FLY%20%20REAR%20DELT-1000x1000.jpg" alt="Firm" class="product-image">
                <div class="overlay">
                    <a href="pinloadedfirm.php" class="quick-view">Quick View</a>
                </div>
            </div>
            <div class="product-info">
        ...
        <div class="product-card">
            <div class="product-badge">Bestseller</div>
            <div class="image-container">
                <img src="https://welcarefitness.com/image/cache/catalog/WA0031-1000x1000.jpg" alt="Smart Watch" class="product-image">
                <div class="overlay">
                    <a href="pinloadedEndure.php" class="quick-view">Quick View</a>
                </div>
            </div>
            <div class="product-info">
                <h3 class="product-name">Endura</h3>
        ...
        <div class="product-card">
            <div class="product-badge">Bestseller</div>
            <div class="image-container">
                <img src="https://welcarefitness.com/image/cache/catalog/EN002A-1000x1000.jpg" alt="Smart Watch" class="product-image">
                <div class="overlay">
                    <a href="pinloadedElitePro.php" class="quick-view">Quick View</a>
                </div>
            </div>
            <div class="product-info">
        ...
        <div class="product-card">
            <div class="product-badge">Bestseller</div>
            <div class="image-container">
                <img src="https://www.maxprofitness.in/cdn/shop/files/MP1823_2048x2048.jpg?v=1704698527" alt="Smart Watch" class="product-image">
                <div class="overlay">
                    <a href="pinloadedMaxpro.php" class="quick-view">Quick View</a>
                </div>
            </div>
            <div class="product-info">
