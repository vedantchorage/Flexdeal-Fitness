...
// Query for Acceserioes products
$accessoriesQuery = "SELECT * FROM products WHERE LOWER(type) = 'Acceserioes'";
$accessoriesResult = $pdo->query($accessoriesQuery);
$accessoriesProduct = $accessoriesResult->fetchAll(PDO::FETCH_ASSOC);
...
@media (max-width: 576px) {
 ...
 /* Banner Section Enhancements */
        ...
        .accessories-banner:hover .banner-image-container img {
...
<body>
        ...
        <div class="container header-container">
            ...
            <nav>
                <ul id="main-nav">
                    ...
                    <li><a href="accessories.php" class="active">Accessories </i></a></li>
    ...
    <section class="accessories-banner">
        <div class="container-fluid p-0"> <!-- Remove default padding -->
            <div class="row g-0"> <!-- Remove gutters -->
                <div class="col-lg-6 order-lg-2"> <!-- Reorder columns on desktop -->
                    <div class="banner-image-container">
                        <img src="https://welcarefitness.com/image/pdf/accessories_banner.jpg"
                            alt="Welcare Medical Accessories" class="img-fluid w-100 h-100 object-fit-cover">
                    </div>
                </div>
    ...
    <section class="product-section">
        <div class="section-header">
            <h2>Premium Fitness Accessories</h2>
            <p>Browse our wide selection of high-quality fitness equipment and accessories</p>
        </div>

       

        <div class="products-container">
            <?php foreach ($accessoriesProduct as $product): ?>
            <?php
