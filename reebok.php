...
$reebokQuery = "SELECT * FROM products WHERE product_name like 'SL%' OR type LIKE 'Reebok'";
...
<body>
  ...
  <section class="product-section">
        ...
        <div class="products-container">
            <?php foreach ($reebokProduct as $product): ?>
            <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Reebok</span>
                    <h3>
