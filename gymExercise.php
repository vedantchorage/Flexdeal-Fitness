...
// Query for Bike_Gym products
$gymExerciseQuery = "SELECT * FROM products WHERE LOWER(type) = 'Bike_Gym' order by price ASC";
$gymExerciseResult = $pdo->query($gymExerciseQuery);
$gymExerciseProduct = $gymExerciseResult->fetchAll(PDO::FETCH_ASSOC);
...
<body>
 ...
 <section class="product-section">
        <div class="section-header">
            <h2>Gym Exercise Bikes</h2>
            <p>Premium commercial-grade exercise bikes for professional gyms and fitness centers</p>
        </div>


    
           <div class="products-container">
            <?php foreach ($gymExerciseProduct as $product): ?>
            <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Gym Exercise Bikes</span>
                    <h3>
