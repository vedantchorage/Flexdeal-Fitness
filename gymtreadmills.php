...
// Query for Treadmill_Gym products
$gymtreadmillQuery = "SELECT * FROM products WHERE LOWER(type) = 'Treadmill_Gym' order by price ASC";
$gymtreadmillResult = $pdo->query($gymtreadmillQuery);
$gymtreadmillProduct = $gymtreadmillResult->fetchAll(PDO::FETCH_ASSOC);
...
<body>
   ...
   <header id="main-header">
    ...
    <!-- add product and used the quotation -->
    <!-- <section>
    <a href="#" class="get-quote-btn" onclick="openQuoteForm('WC4849I MOTORIZED TREADMILL', 'Rs.67,200.00', 'https://welcarefitness.com/image/cache/catalog/WC4849i-1000x1000.jpg')">Get Quote</a>
</section> -->

    <!-- Tredmill -->
      <section class="product-section">
        <div class="section-header">
            <h2>Gym Treadmills</h2>
            <!-- <p>Experience professional-grade running performance in the comfort of your home with our premium treadmill
                collection</p> -->
        </div>

        <div class="products-container">
            <?php foreach ($gymtreadmillProduct as $product): ?>
            <?php
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Gym Treadmills</span>
                    <h3>
