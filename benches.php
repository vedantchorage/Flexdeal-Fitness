...
$benchesQuery = "SELECT * FROM products WHERE LOWER(type) = 'BenchAndRack' order by price ASC";
$benchesResult = $pdo->query($benchesQuery);
$benchesProduct = $benchesResult->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="products-container">
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    <span class="product-category">Benches and Rack</span>
                    <h3>
